...
class ServerTimingHeaderBuilderTest extends TestCase
{
    ...
    public function testEveryTidewaysLayerCountsAsRecognised(): void
    {
        // They are all in the collector's catalog. One missing here does not lose the
        // layer, it makes it compete for the eight slots the collector would not have
        // applied - and the loser is picked by duration, not by relevance.
        $missing = array_diff(ServerTimingStatus::KNOWN_LAYERS, ServerTimingHeaderBuilder::RECOGNISED_LAYERS);
