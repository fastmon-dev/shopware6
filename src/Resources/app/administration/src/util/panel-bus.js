 ...
 * panels live in this bundle, the event carries no payload because every listener reads
...
/**
 * The shop's fastmon connection changed: connected, disconnected, or a different
 * application linked.
 */
export function connectionChanged() {
    listeners.forEach((listener) => {
        try {
            ...
            // One panel failing to refresh must not stop the next one from being told.
